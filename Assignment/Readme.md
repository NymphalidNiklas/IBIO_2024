...
**Assignment** You need to make a concatenated dataset of the 4 genes that have been assigned to you, along with a gene partition file (as you did in [Tutorial 2](../Alignments)), then analyse this dataset in IQ-TREE (as you did in [Tutorial 5](../MaximumLikelihood)), and finally in BEAST (as you did in [Tutorial 6](../6.TimingDivergence)).
